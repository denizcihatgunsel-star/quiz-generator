            ...
            <div className="mt-8 flex flex-wrap justify-center gap-3">
              {data.related.map((r) => (
                <Link
                  key={r.href}
                  href={r.href}
                  className="rounded-full border border-[#F3D5DC] bg-white/70 px-5 py-2.5 text-sm text-[#8C5A68] backdrop-blur-xl transition-colors hover:border-[#B0607A] hover:text-[#3B2027]"
                >
                  {r.label}
                </Link>
              ))}
