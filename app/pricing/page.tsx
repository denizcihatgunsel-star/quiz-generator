            ...
            return (
              <div
                ...
                className={`relative flex flex-col rounded-2xl p-6 transition-all duration-300 ${
                  isFeatured
                    ? "border border-[#B0607A]/40 bg-gradient-to-b from-[#FDE8EC] to-white shadow-[0_30px_80px_-30px_rgba(176,96,122,0.55)] xl:-translate-y-3 xl:scale-[1.02]"
                    : plan.id === "starter"
                    ? "border border-[#F3D5DC] bg-[#FDF4F5]/80 backdrop-blur-xl shadow-[0_16px_50px_-28px_rgba(176,96,122,0.4)]"
                    : "border border-[#F3D5DC] bg-white/70 backdrop-blur-xl shadow-[0_16px_50px_-28px_rgba(176,96,122,0.4)] hover:border-[#E9B8C4] hover:shadow-[0_20px_60px_-28px_rgba(176,96,122,0.5)]"
                }`}
              >
                {/* Badge */}
                {plan.badge && (
